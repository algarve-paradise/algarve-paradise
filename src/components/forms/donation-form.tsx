...
import { ArrowRight, CreditCard, Lock, Shield, Smartphone } from "lucide-react";
...
export function DonationForm() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    router.push(
      `/apoie/sucesso?valor=${finalAmount.toFixed(2)}&metodo=${method}`,
    );
  }
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-10">
      ...
      <div className="space-y-4">
        ...
        {isValid && (
          <div className="flex items-center gap-2 rounded-[1rem] border border-[var(--dt-color-accent)]/20 bg-[var(--dt-color-accent-soft)] px-4 py-3">
      ...
      <div className="space-y-4">
        ...
        {/* Stripe */}
        {method === "stripe" && (
          <div className="space-y-3 rounded-[1.4rem] border border-foreground/8 bg-[var(--dt-color-bg)] p-5">
        ...
        {/* PayPal */}
        {method === "paypal" && (
          <div className="space-y-4 rounded-[1.4rem] border border-[#009cde]/25 bg-[#009cde]/5 p-5">
        ...
        {/* MB Way */}
        {method === "mbway" && (
          <div className="space-y-4 rounded-[1.4rem] border border-[#009640]/25 bg-[#009640]/5 p-5">
            <div className="flex items-center gap-2">
              <MbWayLogo />
            ...
            <div className="relative">
              ...
              <input
                className={cn(fieldCls, "pl-14 font-mono tracking-wider")}
                type="tel"
